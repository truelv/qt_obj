...
DEV_TYPE dev[] =
{
    ...
    {3, "328读卡器", "/data", "reader", SUP_DEV_READER_YT328},
    {4, "312控制器", "/home", "smartdc", SUP_DEV_CONTRL_YT312},
    {5, "312梯控", "/home", "tk", SUP_DEV_TK_YT312},
    {6, "213多媒体POS", "/home", "mpos", SUP_DEV_YT213},
    {7, "215单屏数币POS", "/home", "spos", SUP_DEV_YT215},
    {8, "216双屏数币POS", "/home", "spos", SUP_DEV_YT216},
    {CUM_EOF, 0, 0, 0, 0},
};
...
PLAT_TYPE plat[] =
{
    ...
    {1, "易通", "zyep", SUP_DEV_DCTR_YT328 | SUP_DEV_DCTR_YT327L | SUP_DEV_CONTRL_YT312 | SUP_DEV_YT213 | SUP_DEV_YT215 | SUP_DEV_YT216, SUP_PLAT_YT},
    ...
    {3, "40（pos）", "zytk35",  SUP_DEV_YT213 | SUP_DEV_YT215 | SUP_DEV_YT216, SUP_PLAT_40},
    {5, "易通云", "zyetc", SUP_DEV_DCTR_YT328 | SUP_DEV_DCTR_YT327L | SUP_DEV_YT213 | SUP_DEV_YT215 | SUP_DEV_YT216, SUP_PLAT_ETC},
    {6, "易通云（http）", "zyetch", 0, SUP_PLAT_ETC},
    {7, "出入", "zyacs", SUP_DEV_DCTR_YT328 | SUP_DEV_DCTR_YT327L | SUP_DEV_CONTRL_YT312 | SUP_DEV_TK_YT312, SUP_PLAT_ACS},
    {CUM_EOF, 0, 0, 0, 0},
};
// 设备支持的平台，会映射到这里
